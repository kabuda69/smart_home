...
export default {
  data: function() { return { preferences: [], logs: [], snackbar: { show: false, text: '', color: 'success' } } },
  computed: { ...mapState(['user']) },
  mounted: function() { this.loadPrefs(); this.loadLogs() },
  methods: {
    ...
    loadLogs: function() { var self = this; this.$axios.get('/api/users/logs', { params: { page: 0, size: 10 } }).then(function(r) { if (r.data.success) self.logs = r.data.data.content }) },
